...
public class UserController {
	...
	public ResponseEntity<UserDto.Info> register(
		...
		return new ResponseEntity<UserDto.Info>(new UserDto.Info(userService.createUser(registerInfo)), HttpStatus.CREATED);
	}
...
//		log.info(user.getUseremail() + ", " + user.getPassword());
	...
	public ResponseEntity<UserDto.Info> updateUserInfo(@RequestBody @ApiParam(value = "수정할 회원 정보", required = true) @Valid UserDto.RegisterRequest userInfo) {
