...
var script$2 = vue.defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    vue.watch([config, () => props.options], ([newConfig, newOptions], [oldConfig, oldOptions]) => {
      if (util.isEqualWithFunction(newConfig, oldConfig) && isEqual__default['default'](newOptions, oldOptions))
        return;
      initStore();
